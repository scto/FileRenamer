...
{	
	...
	private void browseTo( final File aDirectory )
	{
		...
		else
		{
			...
			builder.setMessage( "Do you want to open that file?n" + aDirectory.getName() ); 
			...
			AlertDialog.show( this,"Question", R.drawable.folder, "Do you want to open that file?n" + 
						aDirectory.getName(), "OK", 
						okButtonListener, "Cancel", 
						cancelButtonListener, false, null );
			*/
		}
	}
	...
	{
		Intent myIntent = new Intent( android.content.Intent.ACTION_VIEW, Uri.parse( "file://" + aFile.getAbsolutePath() ) );
